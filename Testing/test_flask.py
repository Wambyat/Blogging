...
def login():
    ...
    if request.method == 'POST':
        ...
        if "clear" in request.form:
            ...
            return render_template('login.html', error = error,logo_path = "..\\"+full_filename,img_path = path,new_user_value = "",new_pass_value = "")
        ...
        if user != "":
            ...
            if user in user_names and password == passwords[user_names.index(user)]:
                ...
                return render_template('login.html', error = error,logo_path = "..\\"+full_filename,img_path = path,new_user_value = "before clear",new_pass_value = "pass not cleared")
